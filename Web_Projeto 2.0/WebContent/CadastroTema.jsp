...
<body>
	...
	<div id="main" class="container">
		<h3 class="page-header">Cadastrar Tema</h3>
		<!-- Formulario para inclusao de clientes -->
		<form action="ManterTemaController.do" method="post">
			<!-- area de campos do form -->
			<div class="row">
				<div class="form-group col-md-2">
					<label for="dtCadastro">Data de cadastro</label> <input type="text"
						name="dtCadastro" placeholder="DD/MM/YYYY" pattern="\d{2}/\d{2}/\d{4}"
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<textarea rows="3" class="form-control" name="introducao" required
						id="introducao"></textarea>
				</div>
				<div class="form-group col-md-6">
					<label for="requisitos">Requisitos</label>
					<textarea rows="3" class="form-control" name="requisitos" required
						id="requisitos"></textarea>
